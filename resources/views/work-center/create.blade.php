...
<div class="col-12 grid-margin createtable">
              <div class="card">
                <div class="card-body">
                        ...
                        <div class="row">
                        <div class="col-md-6">
                                 <h4 class="card-title">New Work Center</h4>
                        </div>
          ...
          @endif
                  ...
                  <form class="form-sample"  action="{{ route('work-center.store') }}" method="post" enctype="multipart/form-data"  >
                          {{csrf_field()}}
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Work Center Name" name="name"  required="true"  value="{{old('name')}}" />
                          </div>
                        </div>
                      </div>
