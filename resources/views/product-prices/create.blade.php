  ...
  <div class="content-wrapper">
    ...
    <form action="{{ isset($productPrice) ? route('product-prices.update', $productPrice->id) : route('product-prices.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="original_price" id="original_price" class="form-control" min="1" required>
        </div>
        <div class="mb-3">
            <label for="quantity" class="form-label">Offer Price</label>
            <input type="number" name="offer_price" id="offer_price" class="form-control" min="1" required>
        </div>
